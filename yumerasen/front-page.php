...
?>
            ...
            <div id="inner" class="clearfix mt30">
              <div class="message">
                ...
                <p class="w350"><strong>『夢楽染』が提案する着物ライフ<br />「5つ星」をテーマに着物の楽しみを広げる</strong><br /><br />	夢楽染は関西、東海地方で8店舗を展開し幅広い品揃えとリーズナブルな価格で地域と密着しながら様々な着物のニーズに答えます。
</p>
              ...
              <div class="bnr">
                <p><a href="http://recruit.yumerasen.co.jp/" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/btn02_off.jpg" width="230" height="180" alt="求人情報" /></a></p>
